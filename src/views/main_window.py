...
class Window(QWidget, Ui_Window):
    ...
    def reset_view(self):
        ...
        self.select_method.setCurrentIndex(0)  # Reseta o método de compressão para o padrão
        self.select_compress.setCurrentIndex(0)  # Reseta o tipo de compressão para o padrão
        ...
        self.checkbox_delete.setChecked(False)  # Desmarca a opção de deletar arquivos originais
