...
class Ui_Window(object):
    def setupUi(self, Window):
        ...
        Window.resize(290, 460)
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(Window.sizePolicy().hasHeightForWidth())
        Window.setSizePolicy(sizePolicy)
        Window.setMinimumSize(QSize(290, 200))
        Window.setMaximumSize(QSize(290, 460))
        font = QFont()
        font.setBold(True)
        Window.setFont(font)
        ...
        sizePolicy.setHeightForWidth(self.input_files.sizePolicy().hasHeightForWidth())
        self.input_files.setSizePolicy(sizePolicy)
        ...
        self.btn_load.setGeometry(QRect(204, 30, 80, 30))
...
"")
        ...
        self.label_method.setGeometry(QRect(10, 120, 115, 30))
        ...
        self.slider_level.setGeometry(QRect(10, 230, 271, 30))
        sizePolicy.setHeightForWidth(self.slider_level.sizePolicy().hasHeightForWidth())
        self.slider_level.setSizePolicy(sizePolicy)
        ...
        self.select_method.setGeometry(QRect(202, 120, 82, 30))
        sizePolicy.setHeightForWidth(self.select_method.sizePolicy().hasHeightForWidth())
        self.select_method.setSizePolicy(sizePolicy)
        ...
        self.label_compress.setGeometry(QRect(10, 160, 181, 30))
        sizePolicy.setHeightForWidth(self.label_compress.sizePolicy().hasHeightForWidth())
        self.label_compress.setSizePolicy(sizePolicy)
        ...
        self.label_level.setGeometry(QRect(10, 200, 120, 30))
        ...
        self.layoutWidget.setGeometry(QRect(10, 260, 271, 30))
        ...
        self.input_password.setGeometry(QRect(100, 300, 181, 30))
        ...
        self.label_password.setGeometry(QRect(10, 300, 80, 30))
        ...
        self.btn_exec.setGeometry(QRect(10, 420, 271, 30))
        sizePolicy.setHeightForWidth(self.btn_exec.sizePolicy().hasHeightForWidth())
        self.btn_exec.setSizePolicy(sizePolicy)
...
"")
        ...
        self.label_repeat.setGeometry(QRect(10, 340, 40, 30))
        sizePolicy.setHeightForWidth(self.label_repeat.sizePolicy().hasHeightForWidth())
        self.label_repeat.setSizePolicy(sizePolicy)
        ...
        self.checkbox_delete.setGeometry(QRect(10, 380, 166, 30))
        sizePolicy.setHeightForWidth(self.checkbox_delete.sizePolicy().hasHeightForWidth())
        self.checkbox_delete.setSizePolicy(sizePolicy)
        ...
        self.input_repeat.setGeometry(QRect(100, 340, 181, 30))
        sizePolicy.setHeightForWidth(self.input_repeat.sizePolicy().hasHeightForWidth())
        self.input_repeat.setSizePolicy(sizePolicy)
        ...
        self.list_files.setGeometry(QRect(10, 70, 191, 50))
        sizePolicy.setHeightForWidth(self.list_files.sizePolicy().hasHeightForWidth())
        self.list_files.setSizePolicy(sizePolicy)
        self.list_files.setMinimumSize(QSize(0, 50))
        self.list_files.setMaximumSize(QSize(16777215, 50))
        self.label_total_files = QLabel(Window)
        self.label_total_files.setObjectName(u"label_total_files")
        self.label_total_files.setGeometry(QRect(210, 70, 71, 16))
        sizePolicy.setHeightForWidth(self.label_total_files.sizePolicy().hasHeightForWidth())
        self.label_total_files.setSizePolicy(sizePolicy)
        self.label_total_files.setFont(font)
        self.label_file_count = QLabel(Window)
        self.label_file_count.setObjectName(u"label_file_count")
        self.label_file_count.setGeometry(QRect(210, 100, 71, 16))
        self.label_file_count.setFont(font)
        ...
        self.select_compress.setGeometry(QRect(202, 160, 82, 30))
        sizePolicy.setHeightForWidth(self.select_compress.sizePolicy().hasHeightForWidth())
        self.select_compress.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.drag_and_drop.sizePolicy().hasHeightForWidth())
        self.drag_and_drop.setSizePolicy(sizePolicy)
        self.drag_and_drop.setAcceptDrops(True)
        self.drag_and_drop.setAutoFillBackground(False)
        self.drag_and_drop.setStyleSheet(u"background-color: rgba(0, 0, 0, 0.7);  /* Transpar\u00eancia */\n"
"border: 2px dashed #00BFFF;           /* Borda tracejada azul */")
        ...
        self.verticalLayout = QVBoxLayout(self.drag_and_drop)
        ...
        self.label_drag_and_drop.setFrameShape(QFrame.Shape.NoFrame)
        self.label_drag_and_drop.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.verticalLayout.addWidget(self.label_drag_and_drop)


        self.gridLayout.addWidget(self.drag_and_drop, 0, 0, 1, 1)
        ...
        self.label_total_files.raise_()
        self.label_file_count.raise_()
    ...
    def retranslateUi(self, Window):
        ...
        self.label_total_files.setText(QCoreApplication.translate("Window", u"N\u00ba Arquivos:", None))
